...
book-retails/functions/database_functions.php -> db_connect() . Simple and fast
The base is localhost , root , , book-retails 

to connect the admin section, click the name at the bottom. 
